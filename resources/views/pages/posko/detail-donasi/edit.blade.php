...
@section('title','Edit Detail Donasi')
@section('content')
<!-- Begin Page Content -->
<div class="container-fluid">
    
    <nav class="breadcrumb bg-transparent">
        <a class="breadcrumb-item" href="{{ route('detail-donasi.posko.index',$item->id_donasi) }}">Kembali</a>
        <span class="breadcrumb-item active">Edit Detail Donasi</span>
    </nav>
    
    <!-- DataTales Example -->
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Edit Detail Donasi</h6>
        </div>
        <div class="card-body">
            <form action="{{ route('detail-donasi.posko.update',$item->id_detail_donasi) }}" method="post">
                @csrf
                @method('PUT')
