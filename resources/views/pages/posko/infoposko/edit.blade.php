    ...
    <div class="col-10 offset-1 mt-4 border rounded">
        <form class="my-3" action="{{route('info-posko.update', $item->id_info_posko)}}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('nama_penanggung_jawab') is-invalid @enderror" name="nama_penanggung_jawab" placeholder="Masukkan Nama Penanggung Jawab" required value="{{$item->nama_penanggung_jawab}}">
            ...
            <div class="form-group">
                <label for="no_hp_penanggung_jawab">No Handphone Penanggung Jawab</label>
                <input type="number" class="form-control @error('no_hp_penanggung_jawab') is-invalid @enderror" name="no_hp_penanggung_jawab" placeholder="Masukkan No HP Penanggung Jawab" required value="{{$item->no_hp_penanggung_jawab}}">
