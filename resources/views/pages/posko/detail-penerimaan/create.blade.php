...
@section('title','Tambah Detail Penerimaan Barang')
...
<div class="container-fluid ">
  ...
  <nav class="breadcrumb bg-transparent p-0">
    <a class="breadcrumb-item" href="{{ route('detail-penerimaan-posko',$penerimaanBarang->pengirimanBarang->id_permintaan_barang) }}">Kembali</a>
    <span class="breadcrumb-item active">Tambah Detail Penerimaan Barang</span>
  </nav>
  ...
  <form action="{{ route('detail-penerimaan-posko.store',$penerimaanBarang->id_penerimaan_barang) }}" method="post">
    @csrf
