...
<div class="container-fluid ">
    ...
    <form action="{{route('proses-tambah-pengiriman',$permintaan->id_permintaan_barang)}}" method="post">
        @csrf
        
        <div class="form-group">
            <label >Tanggal Pengiriman</label>
            <input style="width:200px" type="date" required name="tanggal_pengiriman" class="form-control @error('tanggal_pengiriman') is-invalid @enderror" >
        ...
        <div class="col-12 col-md-6 pl-0">
            <div class="form-group">
                ...
                <textarea class="form-control mb-4 @error('keterangan_pengiriman') is-invalid @enderror" required placeholder="Masukkan keterangan" cols="30" rows="3" name="keterangan_pengiriman"></textarea>
