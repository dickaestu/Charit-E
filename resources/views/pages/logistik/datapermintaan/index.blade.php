...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered" id="tablePermintaanLogistik" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            <th>ID Permintaan</th>
                            ...
                            <th>Nomor HP Penanggung Jawab</th>
                            <th>Alamat Posko</th>
                            <th>Keterangan</th>
                            <th>Aksi</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$item->infoposko->nama_penanggung_jawab}}</td>
                            <td>{{$item->infoposko->no_hp_penanggung_jawab}}</td>
    ...
    <script>
        $(document).ready(function() {
            $('#tablePermintaanLogistik').DataTable( {
                "order": [[ 0, "desc" ]]
            } );
        } );    
    </script>    
